/* $Id: discard_server.c 2771 2013-05-30 09:09:07Z dreibh $
 * --------------------------------------------------------------------------
 *
 *           //=====   //===== ===//=== //===//  //       //   //===//
 *          //        //         //    //    // //       //   //    //
...
static unsigned int myRwnd = 0;/*recv window size*/
...
int main(int argc, char **argv)
{
	...
	/* initialize the discard_ulp variable F3*/
	...
	if (myRwndSpecified)
		instanceParameters.myRwnd = myRwnd;/*recv window size 0*/
